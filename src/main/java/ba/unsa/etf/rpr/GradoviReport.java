...
public class GradoviReport extends JFrame {
    ...
    public void showReportNovi(Connection conn, String imeDrzave) throws JRException {
        String reportSrcFile = getClass().getResource("/reports/nekiGradovi.jrxml").getFile();
        String reportsDir = getClass().getResource("/reports/").getFile();
        ...
        HashMap<String, Object> parameters = new HashMap<String, Object>();
        parameters.put("reportsDirPath", reportsDir);
        parameters.put("imeDrzave", imeDrzave);
        ArrayList<HashMap<String, Object>> list = new ArrayList<HashMap<String, Object>>();
        list.add(parameters);
        JasperPrint print = JasperFillManager.fillReport(jasperReport, parameters, conn);
        JRViewer viewer = new JRViewer(print);
